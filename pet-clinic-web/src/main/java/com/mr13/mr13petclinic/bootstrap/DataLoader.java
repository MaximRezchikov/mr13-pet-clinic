package com.mr13.mr13petclinic.bootstrap;

import com.mr13.mr13petclinic.model.*;
...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        Speciality savedDensistry = specialtyService.save(dentistry);
        ...
        owner2.setAddress("123 Private Drive");
        owner2.setCity("Sidney");
        owner2.setTelephone("114080502");

        Pet fionasCat = new Pet();
        fionasCat.setPetType(savedCatPetType);
        fionasCat.setOwner(owner2);
        fionasCat.setBirthday(LocalDate.now());
        fionasCat.setName("Kito");
